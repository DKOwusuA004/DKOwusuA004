...
function triggerConfetti() {
  var end = Date.now() + 5 * 1000; // Duration of 5 seconds
...
// Always run heart trail
window.onload = function () {
  checkDateForConfetti(); // Check for special date
  mwah(); // Start heart trail immediately
};

// Heart effect (same heart trail code you already have)
